...
![Example of default Rich Presence data for an Activity](images/default-presence-activities.webp)
...
![Image of where Rich Presence data appears in Discord profiles for Activities](images/annotated-presence-data-activities.webp)
...
![Example of a fake game's Rich Presence data](images/activities-presence-example.webp)
