...
> danger 
> TODO: document this signature

<Monospace>
startPurchase(args: [StartPurchaseRequest](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/startpurchaserequest)): Promise\<????\>
</Monospace>
...
| [ENTITLEMENT_CREATE](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/entitlementcreate)                                     | Received when an entitlement is created following a purchase of a SKU                     |
